...
export default function DashboardPage() {
  ...
  return (
    <div className="space-y-16 w-full">
      {/* Header Section: High-End Gray Theme */}
      <div className="flex justify-between items-end border-b border-white/5 pb-12">
        <div className="space-y-2">
            ...
            <p className="text-text-muted text-[10px] font-black uppercase tracking-[0.5em] ml-2">
      ...
      <div className="space-y-10">
          ...
          {loading ? (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-10">
             ...
             <div 
                className="group flex flex-col items-center justify-center h-[450px] bg-white/[0.01] border-2 border-dashed border-white/5 rounded-[3rem] text-center cursor-pointer hover:bg-white/[0.03] transition-all" 
